      ...
      <div className="discography-inner">
        ...
        {activeTab === 'albums' ? (
          ...
          <motion.div className="single-list" initial={{ opacity: 0, x: -28 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: .5 }}>
            ...
            <motion.div className="single-info" initial={{ opacity: 0, x: 0, y: 14, scale: .98 }} animate={{ opacity: 1, x: 0, y: 0, scale: 1 }} transition={{ delay: .14, duration: .55, ease: [0.22, 1, 0.36, 1] }}><p lang="en">SINGLE — 2026</p><h3>CRUSH!</h3><span>31 Temmuz 2026 · 2:28</span></motion.div>
